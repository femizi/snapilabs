...
const Header = () => {
  ...
  const openModal = "pt-5 bg-[#232a34] text-lg text-white  h-screen pb-6 px-5"
  const closeModal = "pt-5 hidden h-screen pb-6 px-5"
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6">
        <div className="flex justify-between items-center  py-6 md:justify-start md:space-x-10">
          ...
          <div className="-mr-2 -my-2 md:hidden">
            <button onClick={() => setShowModal(true)} type="button" className="bg-white/5 rounded-md p-2 inline-flex items-center justify-center text-gray-400 hover:text-gray-500 hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-inset focus:ring-indigo-500" aria-expanded="false">
              <span className="sr-only">Open menu</span>
              {/* <!-- Heroicon name: outline/menu --> */}
              <svg className="h-6 w-6 stroke-black" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" aria-hidden="true">
          ...
          <div className={showModal ? openModal : closeModal}>
            ...
            <div className="mt-6">
              <nav className="grid gap-y-8">
                <a href="#" className="-m-3  flex items-center  pb-4 hover:bg-gray-50 border-b-2 border-white">
                ...
                <ul className="border-b-2 border-white pb-4">
                  <li className="">
                ...
                <ul className=" flex justify-evenly">
                  <li>
                    <a data-track-label="facebook" href="https://www.facebook.com/pexels" rel="nofollow" target="_blank" title="Facebook">
                      <i className="icon-facebook"><svg className='fill-white' xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">
                        <path d="M12 0c-6.627 0-12 5.373-12 12s5.373 12 12 12 12-5.373 12-12-5.373-12-12-12zm3 8h-1.35c-.538 0-.65.221-.65.778v1.222h2l-.209 2h-1.791v7h-3v-7h-2v-2h2v-2.308c0-1.769.931-2.692 3.029-2.692h1.971v3z" /></svg></i>
                    </a>
                  </li>
                  <li>
                  ...
                  <li>
                    <a data-track-label="instagram" href="https://instagram.com/pexels/" rel="nofollow" target="_blank" title="Instagram">
                      <i className="rd__svg-icon rd__svg-icon--17x17">
                        <svg className='fill-white' xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">
                  ...
                  <li>
                    <a data-track-label="youtube" href="https://www.youtube.com/c/PexelsPhotos" rel="nofollow" target="_blank" title="YouTube">
                      <svg className='h-[24px] w-[24px] fill-white' xmlns="http://www.w3.org/2000/svg" height="682pt" viewBox="-21 -117 682.66672 682" width="682pt">
