                ...
                <div onClick={() => setnavOpen(!navOpen)} className='relative'>
                    ...
                    <div className={navOpen ? openClass : closeClass}>
                        <div className="text-sm">
                            ...
                            <ul className="py-2 px-2 font-bold">
                                ...
                                <li className='py-2'>
                                    <a className="flex " >
                                        Change Language
                                        <img width="36" height="26" 
                                        className="ml-2" src="https://www.pexels.com/assets/flags/en-US-9ac49f52fbe3cc86ef500da8d7dfac4468c0e98419808425a9cdc1af7714cee1.png" /></a>
                                </li>
                                <li className=" pt-2">
                                ...
                                <li className='py-2'>
                                    <a  data-track-label="api" href="/api/">
                                        Image &amp; Video API
                                    </a>
                                </li>
                                <li className='py-2'>
                                ...
                                <li className='py-2'>
                                    <a href="https://help.pexels.com/hc/en-us" rel="nofollow">
                                        FAQ
                                    </a>
                                </li>
                                <li className='py-2'>
